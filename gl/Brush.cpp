...
Brush::Brush(Texture * texture, glm::vec2 textureScale,float parallaxScale, float parallaxMinLayers, float parallaxMaxLayers, float shininess, float specularStrength, float refractiveIndex){
    this->texture = texture;
