...
Vegetation3d::Vegetation3d() {
    ...
    for (int i = 0; i < planes; ++i) {
        ...
        geometry->addVertex(Vertex(rotate(glm::vec3(-0.5,0,0), axis1, angle), glm::vec3(0,1,0), glm::vec2(0,0),2), false );
        geometry->addVertex(Vertex(rotate(glm::vec3(-0.5,1,0), axis1, angle), glm::vec3(0,1,0), glm::vec2(1,0),2), false );
        geometry->addVertex(Vertex(rotate(glm::vec3(0.5,1,0), axis1, angle), glm::vec3(0,1,0), glm::vec2(1,1),2), false );
    ...
    for (int i = 0; i < planes; ++i) {
        ...
        geometry->addVertex(Vertex(rotate2(glm::vec3(-0.5,0,0), axis1, angle, axis2, PI/4), glm::vec3(0,1,0), glm::vec2(0,0),2), false );
        geometry->addVertex(Vertex(rotate2(glm::vec3(-0.5,1,0), axis1, angle, axis2, PI/4), glm::vec3(0,1,0), glm::vec2(1,0),2), false );
        geometry->addVertex(Vertex(rotate2(glm::vec3(0.5,1,0), axis1, angle, axis2, PI/4), glm::vec3(0,1,0), glm::vec2(1,1),2), false );
