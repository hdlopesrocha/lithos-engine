...
void GamepadControllerStrategy::handleInput(float deltaTime) {
    ...
    if (glfwGetGamepadState(GLFW_JOYSTICK_1, &state)) {
        ...
        component3d0.x = state.axes[GLFW_GAMEPAD_AXIS_RIGHT_X];
        component3d0.y = state.axes[GLFW_GAMEPAD_AXIS_RIGHT_Y];
        component3d0.z = state.axes[GLFW_GAMEPAD_AXIS_RIGHT_TRIGGER] - state.axes[GLFW_GAMEPAD_AXIS_LEFT_TRIGGER];
