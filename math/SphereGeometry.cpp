    ...
    SphereGeometry::SphereGeometry(int lats, int longs) {
        ...
        for(int i = 0; i <= lats; i++) {
            ...
            for(int j = 0; j <= longs; j++) {
                ...
                addVertex(getVertex( x0 * zr0, y0 * zr0, z0 ), false);
                addVertex(getVertex( x1 * zr1, y1 * zr1, z1 ), false);
                addVertex(getVertex( x0 * zr1, y0 * zr1, z1 ), false);


                addVertex(getVertex( x0 * zr0, y0 * zr0, z0 ), false);
                addVertex(getVertex( x1 * zr0, y1 * zr0, z0 ), false);
                addVertex(getVertex( x1 * zr1, y1 * zr1, z1 ), false);
